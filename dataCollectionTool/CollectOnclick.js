i = 0;
mugWithLogoPath = "googleImage/mugWithLogo";
mugWithoutLogoPath = "googleImage/mugWithoutLogo";

function downloadImage(event, path, index){
    console.log(event.srcElement.currentSrc)

    const link = document.createElement('a')
    link.href = event.srcElement.currentSrc
    link.download = path+i
...
function downloadOnMouseClicked(event){
    switch (event.which) {
        case 1:
            downloadImage(event, mugWithLogoPath, i++);
            break;
        case 2:
            alert('Middle Mouse button pressed.');
            break;
        case 3:
            downloadImage(event, mugWithoutLogoPath, i++);
            break;
        default:
...
onmousedown = downloadOnMouseClicked;
